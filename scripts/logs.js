const updates = [
    ...
    ["2023-01-18", "Completed minesweeper", "Removed ability to put flag on revealed tiles", "More tiles are now revealed after first click", "Added minor changes", "Pretty significant code optimization"],
    //[]
];
let index = 1;
