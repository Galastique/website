const projects = [
    ...
    ["Snake (mostly completed)", "snake", "The one game that every programmer that has ever existed has made. <u>Solid Snake II: The Snakening Part 1.</u><br><br>Use the W A S D keys or the arrow keys to move around and try to eat as many fruit as possible. Watch out for that persky tail of yours! You wouldn't wanna choke would you? <br><br> It's a pretty generic snake game all things considered."],
