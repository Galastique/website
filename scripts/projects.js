const projects = [
    ...
    ["Minesweeper (~85% done)", "minesweeper", "This is a pretty basic minesweeper recreation. It hasn't been implemented yet, so I don't really know what to put here, but I hope you enjoy it when it eventually comes."],
